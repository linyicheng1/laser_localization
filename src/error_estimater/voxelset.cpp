...
namespace match_error {
    ...
    void VoxelSet::set_cloud(pcl::PointCloud<pcl::PointXYZI>::ConstPtr cloud) {
        voxels.clear();
    ...
    double VoxelSet::matching_error(const pcl::PointCloud<pcl::PointXYZI>& cloud, double* inlier_fraction) const {
        int num_inliers = 0;
        double errors = 0.0;
